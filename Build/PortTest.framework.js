...
var ASM_CONSTS = {
  7503144: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 7503199: ($0) => { performance.now = function() { return $0; }; },  
 7503247: ($0) => { performance.now = function() { return $0; }; },  
 7503295: () => { performance.now = Module['emscripten_get_now_backup']; }
};
